...
REPL = 'inputs.devices.led.led.LED("/sys/class/leds/input99::capslock")'
...
class LEDTestCase(TestCase):
    ...
    @mock.patch("inputs.devices.led.led.open", mock.mock_open(read_data="1"))
    ...
    @mock.patch("inputs.devices.led.led.open", mock.mock_open(read_data="Hello"))
    ...
    @mock.patch("inputs.devices.led.led.open", mock.mock_open(read_data="2"))
    ...
    @mock.patch("inputs.devices.led.led.open", mock.mock_open(read_data="Brilliant"))
    ...
    def test_write_device(self, mock_io_open):
        ...
        inputs.devices.led.led.NIX = True
        led = LED(None, PATH, NAME)
    ...
    def test_write_device_non_linux(self):
        ...
        inputs.devices.led.led.NIX = False
        led = LED(None, PATH, NAME)
