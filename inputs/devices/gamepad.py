...
from inputs.platforms.win.gamepad import XinputVibration, delay_and_stop

from inputs.constants import XINPUT_ERROR_DEVICE_NOT_CONNECTED, XINPUT_ERROR_SUCCESS
